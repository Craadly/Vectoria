...
const raw = {
  ...
  // Freepik API for Inspiration
  FREEPIK_API_KEY: toStr(process.env.FREEPIK_API_KEY),
...
function validateConfig(cfg) {
  ...
  if (!cfg.FREEPIK_API_KEY) warnings.push('FREEPIK_API_KEY is missing — Inspiration features will not work.');
  ...
  if (cfg.FREEPIK_API_KEY && !/^[a-zA-Z0-9]{20,200}$/.test(cfg.FREEPIK_API_KEY)) {
